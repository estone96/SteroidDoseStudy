...
return_output = function(){
  ...
  mskAE = rbind(c('logistic regression',vanilla_logistic[c(1,2,3),'mskAE']),
                t(mskae_svm),
                c('weighted logistic regression',weight_logistic[c(1,2,3),'mskAE']))
  
  rownames(mskAE) = rep('mskAE',6)
  
  porosis = rbind(c('logistic regression',vanilla_logistic[c(1,2,3),'osteoporosis']),
                  t(porosis_svm),
                  c('weighted logistic regression',weight_logistic[c(1,2,3),'Osteoporosis']))
  
  rownames(porosis) = rep('Osteoporosis',6)
  
  necrosis= rbind(c('logistic regression',vanilla_logistic[c(1,2,3),'osteonecrosis']),
                  t(necrosis_svm),
                  c('weighted logistic regression',weight_logistic[c(1,2,3),'Osteonecrosis']))
  
  rownames(necrosis) = rep('Osteonecrosis',6)
  
  pathologicfrac= rbind(c('logistic regression',vanilla_logistic[c(1,2,3),'pathologicfrac']),
                        t(frac_svm),
                        c('weighted logistic regression',weight_logistic[c(1,2,3),'PathologicFacture']))
  
  rownames(pathologicfrac) = rep('PathologicFrac',6)
